...
<body>
	<section class="hideContainer">
		<header class="hideHeader"> <h1>게임 만들기 STEP 2/4</h1> </header>
			<div class="qr">
				<img src="../resources/img/kakaoQR.png" style="width: 80px; height: 80px;">
					궁금한것은 여기!
				</div>
			<form action="quizSetHint2.do" name="quizSet" onsubmit="return nullCheck()">
...
<div class="allHintBox">
	<div class="hintBox">
		...
		<input name="ordr" id="ordr" value="2" type="hidden">
	</div>
